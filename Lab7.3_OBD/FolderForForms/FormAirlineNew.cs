...
{
    public partial class FormAirlineNew : Form
    {
        public FormAirlineNew()
        {
            InitializeComponent();
        }
        ...
        private void FormAirlineNew_Load(object sender, EventArgs e)
        {
        ...
        private void buttonTourAdd_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("AddAirline", connection);

            command.CommandType = CommandType.StoredProcedure;
            if (dictLocation.TryGetValue(comboBoxLocation.Text, out valueLocation))
            {
                command.Parameters.Add("@ID_IATA", SqlDbType.VarChar).Value = textBoxID.Text;
                ...
                command.Parameters.Add("@Airline_Cost", SqlDbType.Money).Value = textBoxCost.Text;
            }
